...
import type {
  ...
  Convert_pdf_convert_postBody,
  Convert_pdf_convert_postResponse,
  ...
  Split_pdf_split_postBody,
  Split_pdf_split_postResponse,
...
export const createOperations = (apiClient: ApiClient) => ({
   ...
   * 
   * @operationId split_pdf_split_post
   * @method POST
   * @path /pdf/split
   */
  split_pdf_split_post: (data: Split_pdf_split_postBody, config?: AxiosRequestConfig): Promise<Result<Split_pdf_split_postResponse>> => apiClient.post("/pdf/split", data, config),

  /**
   * Queue a file conversion
   * Validate the upload(s) and conversion pair, then queue a convert job.
   * 
   * @operationId convert_pdf_convert_post
   * @method POST
   * @path /pdf/convert
   */
  convert_pdf_convert_post: (data: Convert_pdf_convert_postBody, config?: AxiosRequestConfig): Promise<Result<Convert_pdf_convert_postResponse>> => apiClient.post("/pdf/convert", data, config),
